...
#define STRING_CONFIG_H_AUTHOR "(famagotchi, Ender-3 Pro SKR 1.4)" // Who made the changes.
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  23.1750
    #define DEFAULT_Ki   1.8915
    #define DEFAULT_Kd  70.9851
  #endif
#else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, -1.6 }
...
#define Y_MIN_POS -15
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE+20) // 250mm total
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  0, (-12.3 + 4), (Z_MIN_POS) + 5 } }
  #define NOZZLE_CLEAN_END_POINT   { { 30, (-12.3 - 4), (Z_MIN_POS) + 5 } }
    ...
    #define NOZZLE_CLEAN_CIRCLE_MIDDLE { { 15, -12.3, (Z_MIN_POS) + 5 } } // Middle point of circle
  #endif
